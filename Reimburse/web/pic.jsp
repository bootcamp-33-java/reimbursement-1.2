...
<html>
    ...
    <%  if (session.getAttribute("pics") == null) {
            response.sendRedirect("pic");
//
        } else {
            List<Reimburse> reimbursees = (List<Reimburse>) session.getAttribute("pics");
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="pic?action=approved" method="POST">
                            ...
                            <!--modal reject-->
                            <form action="pic?action=reject" method="POST">
